...
class DeonticRules:
    ...
    def maintain_rules():
        return [
            f"\n% Maintain Obligation",
            f"#program dynamic.",
            f"{maintain_obligation('Obligation', 'Until')} :- {maintain_obligation('Obligation', 'Until', prev=True)}, not {holds('Until', prev=True)}, not {cancel_maintain_obligation('Obligation', 'Until')}.",
            f"{maintain_default_obligation('Obligation', 'Until')} :- {maintain_default_obligation('Obligation', 'Until', prev=True)}, not {holds('Until', prev=True)}, not {cancel_maintain_default_obligation('Obligation', 'Until')}.",
            f"{maintain_permission('Permission', 'Until')} :- {maintain_permission('Permission', 'Until', prev=True)}, not {holds('Until', prev=True)}, not {cancel_maintain_permission('Permission', 'Until')}.",
            f"{maintain_default_permission('Permission', 'Until')} :- {maintain_default_permission('Permission', 'Until', prev=True)}, not {holds('Until', prev=True)}, not {cancel_maintain_default_permission('Permission', 'Until')}.",
            f"{maintain_prohibition('Prohibition', 'Until')} :- {maintain_prohibition('Prohibition', 'Until', prev=True)}, not {holds('Until', prev=True)}, not {cancel_maintain_prohibition('Prohibition', 'Until')}.",
            f"{maintain_default_prohibition('Prohibition', 'Until')} :- {maintain_default_prohibition('Prohibition', 'Until', prev=True)}, not {holds('Until', prev=True)}, not {cancel_maintain_default_prohibition('Prohibition', 'Until')}.",
            f"{maintain_omission('Omission', 'Until')} :- {maintain_omission('Omission', 'Until', prev=True)}, not {holds('Until', prev=True)}, not {cancel_maintain_omission('Omission', 'Until')}.",
            f"{maintain_default_omission('Omission', 'Until')} :- {maintain_default_omission('Omission', 'Until', prev=True)}, not {holds('Until', prev=True)}, not {cancel_maintain_default_omission('Omission', 'Until')}.",
            f"#program always.",
            f"{obligatory('Obligation')} :- {maintain_obligation('Obligation', 'Until')}, not {holds('Until', prev=True)}, not {omissible('Obligation')}.",
    ...
    def achieve_rules():
        return [
            ...
            f"{achieve_default_obligation('Obligation', 'Until')} :- {achieve_default_obligation('Obligation', 'Until', prev=True)}, not {holds('Until', prev=True)}, not {holds('Obligation', prev=True)}, not {cancel_achieve_default_obligation('Obligation', 'Until')}.",
            ...
            f"-{achieve_default_obligation('Obligation', 'Until')} :- {cancel_achieve_default_obligation('Obligation', 'Until')}.",
            f"{cancel_achieve_default_obligation('Obligation', 'Until')} :- -{achieve_default_obligation('Obligation', 'Until')}.",
            f"{default_obligation('Obligation')} :- {achieve_default_obligation('Obligation', 'Until')}, {holds('Until')}.",
            f"{default_obligation('Obligation')} :- {achieve_default_obligation('Obligation', 'Until')}, {holds('Obligation')}.",
